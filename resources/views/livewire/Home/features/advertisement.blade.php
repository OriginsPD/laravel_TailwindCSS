<div>
    ...
    <div style="clip-path: polygon(0 0, 100% 0%, 100% 85%, 50% 100%, 0 85%);
                               background:url('https://cdn.pixabay.com/photo/2014/09/07/22/34/car-race-438467_960_720.jpg') rgba(255,0,0,0.87)  no-repeat;
                               background-size: cover;
                               ">

        <div class="bg-opacity-80 w-screen h-screen py-12 bg-purple-800"
            style="clip-path: polygon(0 0, 100% 0%, 100% 85%, 50% 100%, 0 85%);">

            <div class="container flex-row items-center justify-center px-6 py-8 mx-auto text-center">

                <div class="mx-auto py-4 w-full">

                    <h1 class="text-3xl w-full font-bold text-white dark:text-white md:text-7xl">
                        Jamaica's Premium Car Rental Service <br /><span class="text-5xl t">
                            Since 2022
                            .
                        </span></h1>
                ...
                {{-- <div class="max-w-lg mx-auto py-8 ">--}}
                    ...
                    {{-- <p class="mt-6 text-white dark:text-gray-300">--}}
                        ...
                        {{-- Need a rental car in Jamaica? There is only one choice. <br /> Half Time Car Rentals
                        Ltd--}}

                        {{-- </p>--}}

                    {{-- <div--}} {{--
                        class="w-full max-w-sm mx-auto mt-6 bg-white border rounded-md dark:border-gray-700 focus-within:border-blue-400 focus-within:ring focus-within:ring-blue-300 dark:focus-within:border-blue-300 focus-within:ring-opacity-40">
                        --}}
                        {{-- <form class="flex flex-col md:flex-row">--}}
                            ...
                            {{-- <button type="button" --}} {{--
                                class="h-10 px-4 py-2 m-1 text-white transition-colors duration-200 transform bg-purple-700 rounded-md hover:bg-blue-400 focus:outline-none focus:bg-blue-400">--}}
                                {{-- Ask Us Now--}}
                                {{-- </button>--}}
                            {{-- </form>--}}
                        {{-- </div>--}}
            ...
            <div class="max-w-screen-xl mx-auto mt-20">
                <div class="grid grid-cols-2 gap-8 md:grid-cols-6 lg:grid-cols-5">
                    <div class="flex items-center justify-center col-span-1 md:col-span-2 lg:col-span-1">
                        <svg class="h-12 text-white fill-current dark:text-gray-300" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 266 100">
                    ...
                    <div class="flex items-center justify-center col-span-1 md:col-span-2 lg:col-span-1">
                        <svg class="h-10 text-white fill-current dark:text-gray-300" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="flex items-center justify-center col-span-1 md:col-span-2 lg:col-span-1">
                        <svg class="h-8 mt-2 text-white fill-current dark:text-gray-300" viewBox="0 0 398 120"
                    ...
                    <div class="flex items-center justify-center col-span-1 md:col-span-3 lg:col-span-1">
                        <svg class="h-5 mt-1 text-white fill-current dark:text-gray-300"
                    ...
                    <div class="flex items-center justify-center col-span-2 md:col-span-3 lg:col-span-1">
                        <svg class="h-8 text-white fill-current dark:text-gray-300" viewBox="0 0 2270 546"
                            xmlns="http://www.w3.org/2000/svg">
                            <g fill-rule="evenodd">
                                <path
